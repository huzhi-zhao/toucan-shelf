...
|---|---|
| [roadmap.md](roadmap.md) 能力阶段（待办见根目录 `TODO.md`） | `adr/` 一个**选型**的取舍 |
...
- **进度不进文档。** 本目录任何文档都不写"✅ 已完成 / ⏸️ 待办"。
  待办的**唯一索引**是仓库根目录的 [TODO.md](../../TODO.md)：一行一条指回定论
  所在的文档，不写排期、负责人、当前状态。
  [roadmap.md](roadmap.md) 记的是**已交付到什么程度**及随之定下的结构性事实，
  不是待办清单。
...
- [20260902-attachment-storage-migration.md](design/20260902-attachment-storage-migration.md)
  —— 附件存储迁移：S3 配置的"怎么连/在哪儿"二分、先复制后一次性切换、
  服务端复制的判定条件与分阶段切风险

> 本清单落后于目录实际内容，`20260813`、`20260827`、`20260829` 三篇尚未登记，
> 下次接触本文件时补齐。
