...
const (
	...
	// SECRET_KEY is the key for the user's wrapped `toucan-secret` master key.
	UserSetting_SECRET_KEY UserSetting_Key = 8
)
...
func (x *UserSetting) GetSecretKeySetting() *UserSetting_SecretKeySetting {
	if x != nil {
		if x, ok := x.Value.(*UserSetting_SecretKeySetting_); ok {
			return x.SecretKeySetting
		}
	}
	return nil
}
...
type UserSetting_SecretKeySetting_ struct {
	SecretKeySetting *UserSetting_SecretKeySetting `protobuf:"bytes,9,opt,name=secret_key_setting,json=secretKeySetting,proto3,oneof"`
}
...
func (*UserSetting_SecretKeySetting_) isUserSetting_Value() {}
...
// The user's `toucan-secret` master key, wrapped under a passphrase in the
// browser. Every field is opaque to the server, which holds neither the master
// key nor the passphrase and cannot recover either.
//
// Blocks encrypt against the master key, not the passphrase, so changing the
// passphrase replaces only this record — no block is touched. Conversely,
// clearing this record renders every `toucan-secret` block permanently
// unreadable, which is why there is no way to unset it by accident.
type UserSetting_SecretKeySetting struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	...
	// Base64 HMAC over the canonical parameter header, letting the client tell a
...
func (x *UserSetting_SecretKeySetting) Reset() {
	*x = UserSetting_SecretKeySetting{}
	mi := &file_api_v1_user_service_proto_msgTypes[50]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UserSetting_SecretKeySetting) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UserSetting_SecretKeySetting) ProtoMessage() {}

func (x *UserSetting_SecretKeySetting) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_user_service_proto_msgTypes[50]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UserSetting_SecretKeySetting.ProtoReflect.Descriptor instead.
func (*UserSetting_SecretKeySetting) Descriptor() ([]byte, []int) {
	return file_api_v1_user_service_proto_rawDescGZIP(), []int{13, 5}
}

func (x *UserSetting_SecretKeySetting) GetKdf() string {
	if x != nil {
		return x.Kdf
	}
	return ""
...
func (x *UserSetting_SecretKeySetting) GetKdfIterations() int32 {
	if x != nil {
...
func (x *UserSetting_SecretKeySetting) GetCipher() string {
	if x != nil {
		return x.Cipher
	}
	return ""
...
func (x *UserSetting_SecretKeySetting) GetSalt() string {
	if x != nil {
		return x.Salt
	}
	return ""
...
func (x *UserSetting_SecretKeySetting) GetNonce() string {
	if x != nil {
		return x.Nonce
	}
	return ""
...
func (x *UserSetting_SecretKeySetting) GetVerifier() string {
	if x != nil {
		return x.Verifier
	}
	return ""
...
func (*UserSetting_LastOpenedSetting) Descriptor() ([]byte, []int) {
	return file_api_v1_user_service_proto_rawDescGZIP(), []int{13, 6}
}
...
const file_api_v1_user_service_proto_rawDesc = "" +
	...
	"\x06cipher\x18\x03 \x01(\tB\x03\xe0A\x01R\x06cipher\x12\x17\n" +
	"\x04salt\x18\x04 \x01(\tB\x03\xe0A\x01R\x04salt\x12\x19\n" +
	...
	"\n" +
	"RAG_SEARCH\x10\a\x12\x0e\n" +
	"\n" +
	"SECRET_KEY\x10\b:]\xeaAZ\n" +
...
var file_api_v1_user_service_proto_goTypes = []any{
	...
	(*UserSetting_SecretKeySetting)(nil),        // 54: memos.api.v1.UserSetting.SecretKeySetting
	(*UserSetting_LastOpenedSetting)(nil),       // 55: memos.api.v1.UserSetting.LastOpenedSetting
	nil,                                         // 56: memos.api.v1.UserSetting.TagsSetting.TagsEntry
	nil,                                         // 57: memos.api.v1.UserSetting.LastOpenedSetting.WorkspaceMemosEntry
...
var file_api_v1_user_service_proto_depIdxs = []int32{
	...
	55, // 19: memos.api.v1.UserSetting.last_opened_setting:type_name -> memos.api.v1.UserSetting.LastOpenedSetting
	53, // 20: memos.api.v1.UserSetting.rag_search_setting:type_name -> memos.api.v1.UserSetting.RagSearchSetting
	54, // 21: memos.api.v1.UserSetting.secret_key_setting:type_name -> memos.api.v1.UserSetting.SecretKeySetting
	17, // 22: memos.api.v1.UpdateUserSettingRequest.setting:type_name -> memos.api.v1.UserSetting
	62, // 23: memos.api.v1.UpdateUserSettingRequest.update_mask:type_name -> google.protobuf.FieldMask
	17, // 24: memos.api.v1.ListUserSettingsResponse.settings:type_name -> memos.api.v1.UserSetting
	22, // 25: memos.api.v1.ListLinkedIdentitiesResponse.linked_identities:type_name -> memos.api.v1.LinkedIdentity
	61, // 26: memos.api.v1.PersonalAccessToken.created_at:type_name -> google.protobuf.Timestamp
	61, // 27: memos.api.v1.PersonalAccessToken.expires_at:type_name -> google.protobuf.Timestamp
	61, // 28: memos.api.v1.PersonalAccessToken.last_used_at:type_name -> google.protobuf.Timestamp
	28, // 29: memos.api.v1.ListPersonalAccessTokensResponse.personal_access_tokens:type_name -> memos.api.v1.PersonalAccessToken
	28, // 30: memos.api.v1.CreatePersonalAccessTokenResponse.personal_access_token:type_name -> memos.api.v1.PersonalAccessToken
	61, // 31: memos.api.v1.UserWebhook.create_time:type_name -> google.protobuf.Timestamp
	61, // 32: memos.api.v1.UserWebhook.update_time:type_name -> google.protobuf.Timestamp
	34, // 33: memos.api.v1.ListUserWebhooksResponse.webhooks:type_name -> memos.api.v1.UserWebhook
	34, // 34: memos.api.v1.CreateUserWebhookRequest.webhook:type_name -> memos.api.v1.UserWebhook
	34, // 35: memos.api.v1.UpdateUserWebhookRequest.webhook:type_name -> memos.api.v1.UserWebhook
	62, // 36: memos.api.v1.UpdateUserWebhookRequest.update_mask:type_name -> google.protobuf.FieldMask
	4,  // 37: memos.api.v1.UserNotification.sender_user:type_name -> memos.api.v1.User
	2,  // 38: memos.api.v1.UserNotification.status:type_name -> memos.api.v1.UserNotification.Status
	61, // 39: memos.api.v1.UserNotification.create_time:type_name -> google.protobuf.Timestamp
	3,  // 40: memos.api.v1.UserNotification.type:type_name -> memos.api.v1.UserNotification.Type
	58, // 41: memos.api.v1.UserNotification.memo_comment:type_name -> memos.api.v1.UserNotification.MemoCommentPayload
	59, // 42: memos.api.v1.UserNotification.memo_mention:type_name -> memos.api.v1.UserNotification.MemoMentionPayload
	42, // 43: memos.api.v1.ListUserNotificationsResponse.notifications:type_name -> memos.api.v1.UserNotification
	42, // 44: memos.api.v1.UpdateUserNotificationRequest.notification:type_name -> memos.api.v1.UserNotification
	62, // 45: memos.api.v1.UpdateUserNotificationRequest.update_mask:type_name -> google.protobuf.FieldMask
	63, // 46: memos.api.v1.UserSetting.TagMetadata.background_color:type_name -> google.type.Color
	56, // 47: memos.api.v1.UserSetting.TagsSetting.tags:type_name -> memos.api.v1.UserSetting.TagsSetting.TagsEntry
	34, // 48: memos.api.v1.UserSetting.WebhooksSetting.webhooks:type_name -> memos.api.v1.UserWebhook
	57, // 49: memos.api.v1.UserSetting.LastOpenedSetting.workspace_memos:type_name -> memos.api.v1.UserSetting.LastOpenedSetting.WorkspaceMemosEntry
	50, // 50: memos.api.v1.UserSetting.TagsSetting.TagsEntry.value:type_name -> memos.api.v1.UserSetting.TagMetadata
	5,  // 51: memos.api.v1.UserService.ListUsers:input_type -> memos.api.v1.ListUsersRequest
	7,  // 52: memos.api.v1.UserService.BatchGetUsers:input_type -> memos.api.v1.BatchGetUsersRequest
	9,  // 53: memos.api.v1.UserService.GetUser:input_type -> memos.api.v1.GetUserRequest
	10, // 54: memos.api.v1.UserService.CreateUser:input_type -> memos.api.v1.CreateUserRequest
	11, // 55: memos.api.v1.UserService.UpdateUser:input_type -> memos.api.v1.UpdateUserRequest
	12, // 56: memos.api.v1.UserService.DeleteUser:input_type -> memos.api.v1.DeleteUserRequest
	15, // 57: memos.api.v1.UserService.ListAllUserStats:input_type -> memos.api.v1.ListAllUserStatsRequest
	14, // 58: memos.api.v1.UserService.GetUserStats:input_type -> memos.api.v1.GetUserStatsRequest
	18, // 59: memos.api.v1.UserService.GetUserSetting:input_type -> memos.api.v1.GetUserSettingRequest
	19, // 60: memos.api.v1.UserService.UpdateUserSetting:input_type -> memos.api.v1.UpdateUserSettingRequest
	20, // 61: memos.api.v1.UserService.ListUserSettings:input_type -> memos.api.v1.ListUserSettingsRequest
	23, // 62: memos.api.v1.UserService.ListLinkedIdentities:input_type -> memos.api.v1.ListLinkedIdentitiesRequest
	25, // 63: memos.api.v1.UserService.CreateLinkedIdentity:input_type -> memos.api.v1.CreateLinkedIdentityRequest
	26, // 64: memos.api.v1.UserService.GetLinkedIdentity:input_type -> memos.api.v1.GetLinkedIdentityRequest
	27, // 65: memos.api.v1.UserService.DeleteLinkedIdentity:input_type -> memos.api.v1.DeleteLinkedIdentityRequest
	29, // 66: memos.api.v1.UserService.ListPersonalAccessTokens:input_type -> memos.api.v1.ListPersonalAccessTokensRequest
	31, // 67: memos.api.v1.UserService.CreatePersonalAccessToken:input_type -> memos.api.v1.CreatePersonalAccessTokenRequest
	33, // 68: memos.api.v1.UserService.DeletePersonalAccessToken:input_type -> memos.api.v1.DeletePersonalAccessTokenRequest
	35, // 69: memos.api.v1.UserService.ListUserWebhooks:input_type -> memos.api.v1.ListUserWebhooksRequest
	37, // 70: memos.api.v1.UserService.CreateUserWebhook:input_type -> memos.api.v1.CreateUserWebhookRequest
	38, // 71: memos.api.v1.UserService.UpdateUserWebhook:input_type -> memos.api.v1.UpdateUserWebhookRequest
	39, // 72: memos.api.v1.UserService.DeleteUserWebhook:input_type -> memos.api.v1.DeleteUserWebhookRequest
	40, // 73: memos.api.v1.UserService.GetUserWebhookSigningSecret:input_type -> memos.api.v1.GetUserWebhookSigningSecretRequest
	43, // 74: memos.api.v1.UserService.ListUserNotifications:input_type -> memos.api.v1.ListUserNotificationsRequest
	45, // 75: memos.api.v1.UserService.UpdateUserNotification:input_type -> memos.api.v1.UpdateUserNotificationRequest
	46, // 76: memos.api.v1.UserService.DeleteUserNotification:input_type -> memos.api.v1.DeleteUserNotificationRequest
	6,  // 77: memos.api.v1.UserService.ListUsers:output_type -> memos.api.v1.ListUsersResponse
	8,  // 78: memos.api.v1.UserService.BatchGetUsers:output_type -> memos.api.v1.BatchGetUsersResponse
	4,  // 79: memos.api.v1.UserService.GetUser:output_type -> memos.api.v1.User
	4,  // 80: memos.api.v1.UserService.CreateUser:output_type -> memos.api.v1.User
	4,  // 81: memos.api.v1.UserService.UpdateUser:output_type -> memos.api.v1.User
	64, // 82: memos.api.v1.UserService.DeleteUser:output_type -> google.protobuf.Empty
	16, // 83: memos.api.v1.UserService.ListAllUserStats:output_type -> memos.api.v1.ListAllUserStatsResponse
	13, // 84: memos.api.v1.UserService.GetUserStats:output_type -> memos.api.v1.UserStats
	17, // 85: memos.api.v1.UserService.GetUserSetting:output_type -> memos.api.v1.UserSetting
	17, // 86: memos.api.v1.UserService.UpdateUserSetting:output_type -> memos.api.v1.UserSetting
	21, // 87: memos.api.v1.UserService.ListUserSettings:output_type -> memos.api.v1.ListUserSettingsResponse
	24, // 88: memos.api.v1.UserService.ListLinkedIdentities:output_type -> memos.api.v1.ListLinkedIdentitiesResponse
	22, // 89: memos.api.v1.UserService.CreateLinkedIdentity:output_type -> memos.api.v1.LinkedIdentity
	22, // 90: memos.api.v1.UserService.GetLinkedIdentity:output_type -> memos.api.v1.LinkedIdentity
	64, // 91: memos.api.v1.UserService.DeleteLinkedIdentity:output_type -> google.protobuf.Empty
	30, // 92: memos.api.v1.UserService.ListPersonalAccessTokens:output_type -> memos.api.v1.ListPersonalAccessTokensResponse
	32, // 93: memos.api.v1.UserService.CreatePersonalAccessToken:output_type -> memos.api.v1.CreatePersonalAccessTokenResponse
	64, // 94: memos.api.v1.UserService.DeletePersonalAccessToken:output_type -> google.protobuf.Empty
	36, // 95: memos.api.v1.UserService.ListUserWebhooks:output_type -> memos.api.v1.ListUserWebhooksResponse
	34, // 96: memos.api.v1.UserService.CreateUserWebhook:output_type -> memos.api.v1.UserWebhook
	34, // 97: memos.api.v1.UserService.UpdateUserWebhook:output_type -> memos.api.v1.UserWebhook
	64, // 98: memos.api.v1.UserService.DeleteUserWebhook:output_type -> google.protobuf.Empty
	41, // 99: memos.api.v1.UserService.GetUserWebhookSigningSecret:output_type -> memos.api.v1.GetUserWebhookSigningSecretResponse
	44, // 100: memos.api.v1.UserService.ListUserNotifications:output_type -> memos.api.v1.ListUserNotificationsResponse
	42, // 101: memos.api.v1.UserService.UpdateUserNotification:output_type -> memos.api.v1.UserNotification
...
func file_api_v1_user_service_proto_init() {
	...
	file_api_v1_user_service_proto_msgTypes[13].OneofWrappers = []any{
		...
		(*UserSetting_SecretKeySetting_)(nil),
	}
