...
UPDATE `memo` SET `title` = CONCAT('memo-', `id`) WHERE `title` = '';

DROP INDEX `idx_memo_workspace_folder` ON `memo`;
CREATE UNIQUE INDEX `idx_memo_workspace_folder_title` ON `memo` (`workspace_id`, `folder_path`(255), `title`);
