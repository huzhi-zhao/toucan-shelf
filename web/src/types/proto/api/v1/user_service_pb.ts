...
export type UserSetting = Message<"memos.api.v1.UserSetting"> & {
  ...
  value: {
    ...
    /**
     * @generated from field: memos.api.v1.UserSetting.SecretKeySetting secret_key_setting = 9;
     */
    value: UserSetting_SecretKeySetting;
...
export type UserSetting_GeneralSetting = Message<"memos.api.v1.UserSetting.GeneralSetting"> & {
   ...
   *
   * @generated from field: bool soft_break_default = 5;
   */
  softBreakDefault: boolean;
};
 ...
 *
 * @generated from message memos.api.v1.UserSetting.SecretKeySetting
 */
export type UserSetting_SecretKeySetting = Message<"memos.api.v1.UserSetting.SecretKeySetting"> & {
  /**
   ...
   *
   * @generated from field: string wrapped_key = 7;
   */
  wrappedKey: string;
   ...
   *
   * @generated from field: string unlock_verifier = 8;
   */
  unlockVerifier: string;
};

/**
 * Describes the message memos.api.v1.UserSetting.SecretKeySetting.
 * Use `create(UserSetting_SecretKeySettingSchema)` to create a new message.
 */
export const UserSetting_SecretKeySettingSchema: GenMessage<UserSetting_SecretKeySetting> = /*@__PURE__*/
...
export const UserSetting_LastOpenedSettingSchema: GenMessage<UserSetting_LastOpenedSetting> = /*@__PURE__*/
  messageDesc(file_api_v1_user_service, 13, 6);
...
export enum UserSetting_Key {
   ...
   *
   * @generated from enum value: SECRET_KEY = 8;
   */
  SECRET_KEY = 8,
}
