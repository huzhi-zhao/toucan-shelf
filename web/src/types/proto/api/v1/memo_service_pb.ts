...
export type Memo = Message<"memos.api.v1.Memo"> & {
   ...
   *
   * @generated from field: optional memos.api.v1.DocConfig doc_config = 27;
   */
  docConfig?: DocConfig | undefined;
   ...
   *
   * @generated from field: bool agent_edit_pending = 28;
   */
  agentEditPending: boolean;
};
...
export enum Memo_DocType {
   ...
   * rather than a mode.
   *
   * @generated from enum value: BLOGVIEW = 5;
   */
  BLOGVIEW = 5,
}
 ...
 *
 * @generated from message memos.api.v1.DocConfig
 */
export type DocConfig = Message<"memos.api.v1.DocConfig"> & {
  /**
   * Whether the document body spans the full width of its pane. Default true.
   *
   * @generated from field: optional bool full_width = 1;
   */
   ...
   *
   * @generated from field: optional bool display_outline = 2;
   */
  displayOutline?: boolean | undefined;

  /**
   * Whether the left secondary sidebar (the folder tree) stays expanded while this
   * document is open. Default true.
   *
   * @generated from field: optional bool display_filter = 3;
   */
   ...
   *
   * @generated from field: optional bool show_properties = 4;
   */
   ...
   * behaviour.
   *
   * @generated from field: optional bool soft_break = 5;
   */
  softBreak?: boolean | undefined;
};

/**
 * Describes the message memos.api.v1.DocConfig.
 * Use `create(DocConfigSchema)` to create a new message.
 */
export const DocConfigSchema: GenMessage<DocConfig> = /*@__PURE__*/
...
/**
 * @generated from message memos.api.v1.AcknowledgeAgentEditRequest
 */
export type AcknowledgeAgentEditRequest = Message<"memos.api.v1.AcknowledgeAgentEditRequest"> & {
  /**
   * Required. The resource name of the memo.
   * Format: memos/{memo}
   *
...
/**
 * Describes the message memos.api.v1.AcknowledgeAgentEditRequest.
 * Use `create(AcknowledgeAgentEditRequestSchema)` to create a new message.
 */
export const AcknowledgeAgentEditRequestSchema: GenMessage<AcknowledgeAgentEditRequest> = /*@__PURE__*/
...
export const MemoHistory_AttachmentSchema: GenMessage<MemoHistory_Attachment> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 34, 0);
...
export const LinkMetadataSchema: GenMessage<LinkMetadata> = /*@__PURE__*/
  messageDesc(file_api_v1_memo_service, 42);
...
export const MemoService: GenService<{
   ...
   *
   * @generated from rpc memos.api.v1.MemoService.AcknowledgeAgentEdit
   */
  acknowledgeAgentEdit: {
    methodKind: "unary";
    input: typeof AcknowledgeAgentEditRequestSchema;
    output: typeof MemoSchema;
  },
  /**
